...
@Configuration
public class ProfileRestClientConfig {
    
    @Bean
    public RestClient fileServiceRestClient(
            ProfileFileServiceProperties properties,
    ...
    private ClientHttpRequestFactory clientHttpRequestFactory(ProfileFileServiceProperties properties) {
