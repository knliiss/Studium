package dev.knalis.testing.client.audit.http;
...
import dev.knalis.testing.config.TestingAuditServiceProperties;
...
public class HttpAuditServiceClient implements AuditServiceClient {
    ...
    private final TestingAuditServiceProperties properties;
