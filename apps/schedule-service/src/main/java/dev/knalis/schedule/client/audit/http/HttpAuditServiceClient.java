package dev.knalis.schedule.client.audit.http;
...
import dev.knalis.schedule.config.ScheduleAuditServiceProperties;
...
public class HttpAuditServiceClient implements AuditServiceClient {
    ...
    private final ScheduleAuditServiceProperties properties;
