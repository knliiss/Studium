...
export function Sidebar({ onToggle, open }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-40 w-72 border-r border-border bg-background-elevated/90 p-4 shadow-[var(--shadow-soft)] backdrop-blur transition-transform lg:static lg:translate-x-0 lg:shadow-none',
          open ? 'translate-x-0' : '-translate-x-full',
        )}
      >
        <div className="flex h-full flex-col">
          <div className="mb-5 rounded-[24px] border border-border bg-surface px-4 py-5 shadow-[var(--shadow-card)]">
          ...
          <div className="sticky bottom-4 mt-4 space-y-3 rounded-[22px] border border-border bg-surface p-4 shadow-[var(--shadow-card)]">
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <div>
                  <p className="text-sm font-semibold text-text-primary">{profileLabel}</p>
